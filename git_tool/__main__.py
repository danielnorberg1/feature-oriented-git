...
from git_tool.ci.subcommands.feature_project import feature_project
...
app.command(name="project", help="Materialize a product variant by selecting features to include.")(feature_project)
